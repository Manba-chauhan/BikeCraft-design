    ...
    <div className="max-w-[1600px] max-h-[680px] mx-auto bg-black px-10 max-md:max-h-full">
      <div className="flex justify-center items-center max-md:flex-col">
        <div className="flex-1">
          <div className=" px-28  max-md:p-10 max-sm:p-5">
            <h1 className="text-5xl font-bold text-white p-2 max-sm:text-3xl">
              bicicletas feitas sob medida.
            </h1>
            <p className="text-gray-400 text-light w-10/12 px-2 py-4 max-md:w-full">
