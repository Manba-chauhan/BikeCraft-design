      ...
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="flex-col justify-between items-center">
          ...
          {/* <div className="max-w-[1160px]  float-right mt-20  bg-black  max-md:bg-transparent   max-md:ml-0"> */}
            <div
              className=" bg-black max-w-[1160px] float-right  mx-auto max-md:h-full
              ...
              <div className="flex-1  ">
                <div className="">
                  <img
                    src={cycle}
                    alt=""
                    className="relative -left-20 top-2  
                      max-md:-left-4 w-full h-full object-cover rounded"
                  />
          ...
          {/* </div> */}
          <div className="mt-[600px] mb-20  max-md:mt-[900px] max-sm:mt-[700px] ">
            <Card />
          </div>
        </div>
        <Footer />
